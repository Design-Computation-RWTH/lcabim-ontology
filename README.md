# LCABIM Ontology (LCA to BIM Workflow)

This repository hosts the published documentation and RDF serializations for the LCABIM ontology stack used in the LCA to BIM Workflow project.
